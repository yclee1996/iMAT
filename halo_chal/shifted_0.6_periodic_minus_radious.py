...
X_train, X_test, y_train, y_test = train_test_split(scaled_para, y,test_size=0.4, random_state = 3)
######################################
######################################
...
for alpha in alpha_list:
    for unit in unit_list:
        ...
        with open("NN_result_3layer_0.6", "a") as p:
            p.write('add_bond_radius_periodic_minus the error of ' + str(unit) + ' unit in each of 3 layers with alpha = '+ str(alpha) +' is '+ 'train: ' + str(train) + ' test: ' + str(test)+"\n")
