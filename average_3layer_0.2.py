...
X_train, X_test, y_train, y_test = train_test_split(scaled_para, y,test_size=0.8, random_state = 3)
######################################
######################################
...
#print (regress())
unit_list = [200,250,300,350]
alpha_list = [0.0001,0.0003]
for alpha in alpha_list:
    for unit in unit_list:
        train, test = regress(unit,alpha)
        with open("NN_result_3layer_0.2", "a") as p:
