...
######################################
mole_test = get_molecule_dataset('ScF2')
######################################
...
for alpha in alpha_list:
    for unit in unit_list:
        ...
        with open("NN_result_3layer_0.4", "a") as p:
            p.write('ScF2_dis_radius_periodic_minus the error of ' + str(unit) + ' unit in each of 3 layers with alpha = '+ str(alpha) +' is '+ 'test: ' + str(test)+"\n")
