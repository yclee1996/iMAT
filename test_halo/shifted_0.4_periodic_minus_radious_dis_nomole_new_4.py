...
def perodic_table(molecule):
    return_list = []
    metal_atom = ['Sc','XXXX','XXXX','XXXX','XXXXX','XXX','XXXX','XXXX','XXXX','XXXX']
...
######################################
mole_test = get_molecule_dataset(name)
######################################
...
for alpha in alpha_list:
    for unit in unit_list:
        ...
        with open("NN_result_3layer_0.4", "a") as p:
            p.write(name+'4_dis_radius_periodic_minus the error of ' + str(unit) + ' unit in each of 3 layers with alpha = '+ str(alpha) +' is '+ 'test: ' + str(test)+"\n")
