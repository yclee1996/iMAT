...
def perodic_table(molecule):
    return_list = []
    metal_atom = ['Sc','Ti','V','Cr','ZZZZZ','ZZZZZ','ZZZZZZ','ZZZZ','ZZZZZ','ZZZZZZ']
...
for alpha in alpha_list:
    for unit in unit_list:
        ...
        with open("NN_result_3layer_0.4", "a") as p:
            p.write('half_dis_radius_periodic_minus the error of ' + str(unit) + ' unit in each of 3 layers with alpha = '+ str(alpha) +' is '+ 'train: ' + str(train) + ' test: ' + str(test)+"\n")
